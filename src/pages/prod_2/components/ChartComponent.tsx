...
import type { OilPricePoint } from '../../../types' // ← путь должен соответствовать структуре
    ...
    datasets: [
      {
        ...
        data: data.map((d) => (isNaN(d.actual) ? null : d.actual)), // ← КЛЮЧ "data:"
      ...
      },
      {
        ...
        data: data.map((d) => d.predicted ?? null), // ← КЛЮЧ "data:"
